...
public class TestableReceiver {
    ...
    private final ReactorKafkaReceiver<Integer, String> kafkaReceiver;

    public TestableReceiver(KafkaReceiver<Integer, String> kafkaReceiver, Flux<ReceiverRecord<Integer, String>> kafkaFlux) {
        this.kafkaReceiver = (ReactorKafkaReceiver<Integer, String>) kafkaReceiver;
    ...
    public void injectCommitEventForRetriableException() {
        ReactorKafkaReceiver<?, ?>.CommitEvent newEvent = kafkaReceiver.new CommitEvent() {
