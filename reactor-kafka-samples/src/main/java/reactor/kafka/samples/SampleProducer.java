...
public class SampleProducer {
    ...
    private final KafkaOutbound<Integer, String> outbound;
    ...
    public SampleProducer(String bootstrapServers) {
        ...
        OutboundOptions<Integer, String> outboundOptions = OutboundOptions.create(props);

        outbound = KafkaOutbound.create(outboundOptions);
    ...
    public void sendMessages(String topic, int count, CountDownLatch latch) throws InterruptedException {
        ...
        outbound.sendAll(Flux.range(1, count)
                        .map(i -> OutboundRecord.create(new ProducerRecord<>(topic, i, "Message_" + i), i)), scheduler, 1024, true)
