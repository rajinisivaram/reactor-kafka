...
public class ReceiverRecord<K, V> implements InboundRecord<K, V> {

    private final ConsumerRecord<K, V> consumerRecord;
    private final Offset consumerOffset;

    public ReceiverRecord(ConsumerRecord<K, V> consumerRecord, Offset consumerOffset) {
